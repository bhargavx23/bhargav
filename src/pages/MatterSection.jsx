  ...
  return (
    <div className="  w-full flex  flex-col   justify-around items-center h-fit">
      <div className=" w-full md:w-3/4  flex-col m-4 md:m-7 gap-10 justify-self-center flex justify-center">
        <h1 className="text-xl md:text-xl lg:text-2xl fadeAnimation font-light md:font-medium  text-center leading-relaxed text-gray-500 px-4">
          A passinated{" "}
        ...
        <div className="flex justify-center w-fit items-center self-center md:self-start ">
          ...
          <a href={Resume} download>
            <button
              type="submit"
              className="bg-white text-black text-xl fadeAnimation rounded-xl md:p-3 p-2   font-medium font-mono font-bold hover:bg-purple-300 active:scale-95  hover:translate-y-[-10px] transition-all duration-300 ease-in-out"
            >
              Resume
            </button>
          </a>
