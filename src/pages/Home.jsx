...
const Home = () => {
  return (
    <div>
      <div className="  realtive bg-[rgb(14,9,17)] md:bg-[rgba(14,9,17,0.55)] items-center z-20  m-0 h-screen md:max-h-[90vh]  w-full flex justify-center flex-col font-[poppins] text-white text-4xl ">
        <TopSection />
        <MatterSection />
